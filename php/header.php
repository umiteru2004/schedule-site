...
<head>
    ...
    <style>
        ...
        header h1 { margin: 0; }
        header h1 a { font-size: 24px; color: #333; text-decoration: none; }
        header .header-menu a { margin-left: 15px; text-decoration: none; color: #007bff; }
        main { padding: 20px; }
        footer { text-align: center; padding: 20px; margin-top: 40px; border-top: 1px solid #ddd; font-size: 14px; color: #777; }
        .container { max-width: 800px; margin: 20px auto; padding: 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 5px; }
    </style>
</head>
<body>
